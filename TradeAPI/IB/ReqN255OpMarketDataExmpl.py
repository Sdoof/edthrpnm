...
def makeUSOptContract(sym, exp, strike, right):
    newOptContract = Contract()
    newOptContract.m_symbol = sym
    newOptContract.m_secType = "OPT"
    newOptContract.m_expiry = exp
...
def makeUSIndexContract(sym, exchange):
    newOptContract = Contract()
    newOptContract.m_symbol = sym
    newOptContract.m_secType = "IND"
    newOptContract.m_expiry = ""
...
opContractList = [
    ...
    makeOptContract(sym='N225', exp='20170413', strike='', right='C'),
    makeOptContract(sym='N225', exp='20170413', strike='', right='P')
]
