...
TicketPackages = []
#First Ticket
SymbolTicket = ['SPXPM', 'SPXPM', 'SPXPM']
ExpiryTicket = ['20150918', '20150918', '20151016']
StrikeTicket = [2000, 2040, 2040]
RightTicket = ['P', 'P', 'P']
...
#Second Ticket
SymbolTicket = [ 'SPX','SPX','SPX' ]
ExpiryTicket = [ '20151119','20151217','20151217' ]
StrikeTicket = [ 2060,2060,2110 ]
RightTicket = [ 'C','C','C' ]
BuySell = [ 'SELL','SELL','BUY' ]
ComboRatio = [ 1,1,2 ]
LimitPrice_G =  -9000
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            print(tkpkg.symbolTicket,tkpkg.expiryTicket,tkpkg.rightTicket,tkpkg.buySell,tkpkg.comboRatio,tkpkg.limitPrice_G,tkpkg.qTY_G)
        except IndexError:
            break
