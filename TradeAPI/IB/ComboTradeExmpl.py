...
LimitPrice_G = -50
QTY_G = 1
SymbolTicket2 = ['SPXPM', 'SPXPM', 'SPXPM']
ExpiryTicket2 = ['20150918', '20150918', '20151016']
StrikeTicket2 = [2140, 2200, 2090]
RightTicket2 = ['C', 'C', 'C']
BuySell2 = ['BUY', 'SELL', 'SELL']
ComboRatio2 = [2, 1, 1]
LimitPrice2_G = -50
QTY2_G = 1
...
if __name__ == '__main__':
    ...
    Leg2 = processAPITicket(SymbolTicket2, ExpiryTicket2, StrikeTicket2, RightTicket2)
