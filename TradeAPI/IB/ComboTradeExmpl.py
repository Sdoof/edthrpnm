...
TicketPackages = []
#First Ticket
SymbolTicket = [ 'SPX','SPX' ]; ExpiryTicket = [ '20170420','20170518' ]; StrikeTicket = [ 2200,2125 ] ; RightTicket = [ 'P','P' ]; BuySell = [ 'SELL','BUY' ]; ComboRatio = [ 1,1 ] ;LimitPrice_G =  -9000  ;QTY_G =  1
...
SymbolTicket = ['SPX', 'SPX']; ExpiryTicket = ['20170420', '20170518']; StrikeTicket = [2300, 2250]; RightTicket = ['P', 'P']; BuySell = ['BUY', 'SELL']; ComboRatio = [1, 1]; LimitPrice_G = -9000; QTY_G =1
theTicketPkg=createTicketPackage(SymbolTicket,ExpiryTicket,StrikeTicket,RightTicket,BuySell,ComboRatio,LimitPrice_G,QTY_G)
queTickets.append(theTicketPkg)

SymbolTicket = ['SPX', 'SPX']; ExpiryTicket = ['20170420', '20170518']; StrikeTicket = [2300, 2275]; RightTicket = ['P', 'P']; BuySell = ['BUY', 'SELL']; ComboRatio = [1, 1]; LimitPrice_G = -9000; QTY_G =1
theTicketPkg=createTicketPackage(SymbolTicket,ExpiryTicket,StrikeTicket,RightTicket,BuySell,ComboRatio,LimitPrice_G,QTY_G)
queTickets.append(theTicketPkg)

#Second Ticket
SymbolTicket = [ 'SPX','SPX' ]; ExpiryTicket = [ '20170420','20170518' ]; StrikeTicket = [ 2350,2325 ] ; RightTicket = [ 'C','C' ]; BuySell = [ 'SELL','BUY' ]; ComboRatio = [ 1,1 ] ;LimitPrice_G =  -9000  ;QTY_G =  1
theTicketPkg=createTicketPackage(SymbolTicket,ExpiryTicket,StrikeTicket,RightTicket,BuySell,ComboRatio,LimitPrice_G,QTY_G)
queTickets.append(theTicketPkg)
