...
TicketPackages = []
#First Ticket
SymbolTicket = ['RUT', 'RUT']; ExpiryTicket = ['20170831', '20170929']; StrikeTicket = [1300, 1240]; RightTicket = ['P', 'P']; BuySell = ['SELL', 'BUY']; ComboRatio = [1, 1]; LimitPrice_G = -9000; QTY_G =1
...
SymbolTicket = ['RUT', 'RUT']; ExpiryTicket = ['20170831', '20170929']; StrikeTicket = [1390, 1370]; RightTicket = ['P', 'P']; BuySell = ['BUY', 'SELL']; ComboRatio = [1, 1]; LimitPrice_G = -9000; QTY_G =1
theTicketPkg=createTicketPackage(SymbolTicket,ExpiryTicket,StrikeTicket,RightTicket,BuySell,ComboRatio,LimitPrice_G,QTY_G)
...
#Second Ticket
#SymbolTicket = ['SPX', 'SPX']; ExpiryTicket = ['20170831', '20170929']; StrikeTicket = [2300, 2225]; RightTicket = ['P', 'P']; BuySell = ['SELL', 'BUY']; ComboRatio = [1, 1]; LimitPrice_G = -9000; QTY_G =1
#theTicketPkg=createTicketPackage(SymbolTicket,ExpiryTicket,StrikeTicket,RightTicket,BuySell,ComboRatio,LimitPrice_G,QTY_G)
#queTickets.append(theTicketPkg)

#SymbolTicket = ['SPX', 'SPX']; ExpiryTicket = ['20170831', '20170929']; StrikeTicket = [2420, 2410]; RightTicket = ['P', 'P']; BuySell = ['BUY', 'SELL']; ComboRatio = [1, 1]; LimitPrice_G = -9000; QTY_G =1
#theTicketPkg=createTicketPackage(SymbolTicket,ExpiryTicket,StrikeTicket,RightTicket,BuySell,ComboRatio,LimitPrice_G,QTY_G)
#queTickets.append(theTicketPkg)
