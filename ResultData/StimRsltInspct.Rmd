...
evalTargetIdx<-data.frame(spread_idx=1,scenario_idx=8,stim_idx=35)
...
gg <- ggplot(data.frame(days=seq(1,Stimdays,by=1),IVIDX=IVIDX_path),aes(x=days,y=IVIDX))+geom_point()+geom_line()+
  geom_point(x=0,y=iniIVIDX,size=3.0,pch=3)+xlim(0,Stimdays)
print(gg)
```
...
gg <- ggplot(data.frame(days=seq(1,Stimdays,by=1),profit=Profit_path),aes(x=days,y=profit))+geom_point()+geom_line()+
  geom_point(x=0,y=0,size=3.0,pch=3)+xlim(0,Stimdays)+ylim(0,max(Profit_path))
print(gg)
```
...
gg <- ggplot(data.frame(days=seq(1,Stimdays,by=1),profit=Profit_path),aes(x=days,y=profit))+geom_point()+geom_line()+
  ...
  xlim(0,Stimdays)+ylim(min(0,DeltaE_path,VegaE_path,ThetaE_path,GammaE_path),
