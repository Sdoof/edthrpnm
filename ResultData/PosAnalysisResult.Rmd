...
for(eval_pos_idx in DrawSpreads){
  ...
  #print thePosition
  thePosition %>% select(Date,ExpDate,TYPE,Strike,Position,ContactName,Price,Delta,OrigIV,IVIDX,Vega,Theta,UDLY) %>% mutate(TYPE=ifelse(TYPE==OpType_Put_G,"Put","Call")) %>% print()
