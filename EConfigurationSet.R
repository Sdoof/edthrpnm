...
#EvalFuncSetting
EvFNames <- c("holdDays","UdlStepNum","UdlStepPct","Posnum","CombineTargetGeneration",
              "LossLimitPrice",
...
EvalFuncSetting[[5]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_CombineTargetGeneration",1])))
...
EvalFuncSetting[[8]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_PriceRangeDist",1])))
EvalFuncSetting[[9]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_Weight_Explicit",1])))
EvalFuncSetting[[10]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_Weight_Explicit_1D",1])))
EvalFuncSetting[[11]]<-ifelse(as.numeric(ConfigParameters["EvalFnc_EvalSigmoidFunc",1])==1,TRUE,FALSE)
EvalFuncSetting[[12]]<-ifelse(as.numeric(ConfigParameters["EvalFnc_EvalEconomicValue",1])==1,TRUE,FALSE)
EvalFuncSetting[[13]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_UnitMinProfit",1])))
EvalFuncSetting[[14]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_Delta_Thresh_Minus",1])))
EvalFuncSetting[[15]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_Delta_Thresh_Plus",1])))
EvalFuncSetting[[16]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_Vega_Thresh_Minus",1])))
EvalFuncSetting[[17]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_Vega_Thresh_Plus",1])))
EvalFuncSetting[[18]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_Delta_Direct_Prf",1])))
EvalFuncSetting[[19]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_Vega_Direct_Prf",1])))
EvalFuncSetting[[20]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_Delta_Neutral_Offset",1])))
EvalFuncSetting[[21]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_Vega_Neutral_Offset",1])))
EvalFuncSetting[[22]]<-as.numeric(ConfigParameters["EvalFnc_Profit_Coef",1])
EvalFuncSetting[[23]]<-as.numeric(ConfigParameters["EvalFnc_AdvEffect_Coef",1])
EvalFuncSetting[[24]]<-as.numeric(ConfigParameters["EvalFnc_AllEffect_Coef",1]) 
EvalFuncSetting[[25]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_DrctlEffect_Coef",1])))
EvalFuncSetting[[26]]<-as.numeric(ConfigParameters["EvalFnc_MaxLoss_Coef",1])
EvalFuncSetting[[27]]<-as.numeric(ConfigParameters["EvalFnc_SigmoidA_Numerator",1])
EvalFuncSetting[[28]]<-as.numeric(ConfigParameters["EvalFnc_SigmoidA_Denominator",1])
EvalFuncSetting[[29]]<-as.numeric(ConfigParameters["EvalFnc_ExpIVChange_Multiple",1])
EvalFuncSetting[[30]]<-ifelse(as.numeric(ConfigParameters["EvalFnc_EvalConvex",1])==1,TRUE,FALSE)
EvalFuncSetting[[31]]<-ifelse(as.numeric(ConfigParameters["EvalFnc_ConvexNormalizeByProfit",1])==1,TRUE,FALSE)
EvalFuncSetting[[32]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_ConvexEvalInCoef",1])))
EvalFuncSetting[[33]]<-ifelse(as.numeric(ConfigParameters["EvalFnc_UseSortinoRatio",1])==1,TRUE,FALSE)
EvalFuncSetting[[34]]<-ifelse(as.numeric(ConfigParameters["EvalFnc_Eval1DayDist",1])==1,TRUE,FALSE)
EvalFuncSetting[[35]]<-as.numeric(ConfigParameters["EvalFnc_Eval1DayDistWeightROnHoldDay",1])
EvalFuncSetting[[36]]<-as.numeric(ConfigParameters["EvalFnc_Coef1DayDist",1])
