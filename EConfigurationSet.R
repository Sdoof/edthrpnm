...
EvFNames <- c("holdDays","UdlStepNum","UdlStepPct","Posnum","Tail_rate","LossLimitPrice",
              "HV_IV_Adjust_Ratio","Weight_Explicit","EvalSigmoidFunc","Weight_Drift","Weight_Skew","Weight_Drift_GreekEffect","Weight_Skew_GreekEffect",
...
EvalFuncSetting[[9]]<-ifelse(as.numeric(ConfigParameters["EvalFnc_EvalSigmoidFunc",1])==1,TRUE,FALSE)
EvalFuncSetting[[10]]<-as.numeric(ConfigParameters["EvalFnc_Weight_Drift",1])
EvalFuncSetting[[11]]<-as.numeric(ConfigParameters["EvalFnc_Weight_Skew",1])
EvalFuncSetting[[12]]<-as.numeric(ConfigParameters["EvalFnc_Weight_Drift_GreekEffect",1])
EvalFuncSetting[[13]]<-as.numeric(ConfigParameters["EvalFnc_Weight_Skew_GreekEffect",1])
...
EvalFuncSetting[[25]]<-as.numeric(ConfigParameters["EvalFnc_DrctlEffect_Coef",1])
...
EvalFuncSetting[[30]]<-ifelse(as.numeric(ConfigParameters["EvalFnc_ThetaEffectPositive",1])==1,TRUE,FALSE)
EvalFuncSetting[[31]]<-ifelse(as.numeric(ConfigParameters["EvalFnc_EvalConvex",1])==1,TRUE,FALSE)
EvalFuncSetting[[32]]<-ifelse(as.numeric(ConfigParameters["EvalFnc_DeltaHedgeToEvalProfit",1])==1,TRUE,FALSE)
EvalFuncSetting[[33]]<-as.numeric(ConfigParameters["EvalFnc_GreekEffectEvalOnHoldDay",1])
