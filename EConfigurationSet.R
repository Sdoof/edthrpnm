...
EvalFuncSetting[[12]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_UnitMinProfit",1])))
...
EvalFuncSetting[[24]]<-eval(parse(text=gsub("\\$",",",ConfigParameters["EvalFnc_DrctlEffect_Coef",1])))
